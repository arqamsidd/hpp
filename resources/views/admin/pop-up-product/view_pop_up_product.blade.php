                            ...
                            @php $i="1"; @endphp
                              ...
                              @foreach($records as $record)
                                <tr>
                                  ...
                                  <td>
                                    <a href="{{ url('admin/edit-popup-product', $record->id)}}" type="button" class="btn btn-primary rounded-pill" >Edit</a>&nbsp;&nbsp; 
...
<script type="text/javascript">
  function confirmation(value){
         event.preventDefault();
          ...
          if (e) {
             window.location.href = "{{url('')}}/admin/delete-popup-product/"+value;
           }
          else{
           }
         });

...
@section('content')
   ...
   <div class="row vertical-modern-dashboard">
      <div class="col s12 m4 l4" style="color: white;">
          Total # of Pages 
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Active Pages <i
               ...
               <h5 class="center-align">Welcome to Hpp Dashboard</h5>
               <p class="medium-small center-align">Used balance this billing cycle</p>
            </div>
         </div>
      </div>
      <div class="col s12 m8 l8 animate fadeRight" style="color: white;">
          Total # of Leads 
         <div class="card">
            <div class="card-content">
               <h4 class="card-title mb-0">Total Leads <i class="material-icons float-right">more_vert</i></h4>
               <p class="medium-small">This month Leads</p>
...
<!--                            <h5 class="intro-step-title mt-7 center animated fadeInUp">Welcome to Half Price Packaging</h5>-->
<!--                            <p class="intro-step-text mt-5 animated fadeInUp">Dashboard and Frontend Modules: Admins and Editor Crud, Categories - (L1) Crud, CTA's (Call to action) For Categories , Sub Categories  (L2) Crud: , CTA's (Call to action) for Sub Categories-->
<!--                                        , Products Crud:-   -->
<!--                                        , Related Products Crud :--->
                                        
<!--                                        Dynamic Search:- -->
                                        
<!--                                        Other business Pages:-  -->
                                        
<!--                                        Blog on home Page Crud:- -->
<!--                                        Instagram API:-  -->

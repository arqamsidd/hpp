...
<head>
  ...
  ?>
  <title><?= $title ?></title>
  <meta name="description" content="{{ !empty($meta_info['meta_description']) ? $meta_info['meta_description'] : 'Grab exclusive custom box packaging from Half Price Packaging at highly competitive prices. Order our best mailer boxes, rigid boxes, and other types.'}}" />
  @if(!empty($meta_info['meta_keywords']))<?php $keywords = explode(',', $meta_info['meta_keywords']) ?>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/accordian-jquery-ui.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/slick.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/slick-theme.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/font-awesome.min.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/icomo.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/font/fonts.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/hover-min.css">
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/side-menu.css">
  <link rel="icon" type="image/gif" href="{{asset('frontend')}}//images/fav.png" />
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/xzoom.min.css" media="all" />
  <link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/css/magnific-popup.css" media="all" />
    ...
    window.addEventListener('scroll', function() {
      ...
      if (scroll > 0 && fired === false) {
        ...
        (function() {
          ...
          mf.defer = true;
          mf.src = "//cdn.mouseflow.com/projects/90ff3889-1dbe-4f1f-9d1c-4d0e1fc4407a.js";
...
<body class="<?php echo $page_check ?>">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WDX5T2S" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <header>
    <div class="container-fluid">
      <nav class="navbar fixed-top navbar-expand-xl navbar-dark">
        <div class="container-fluid">
          <button id="sidebarCollapse" class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="row">
              <div class="col-md-4 head-col-1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.0s">
                <div class="social-link">
                  <ul>
                    <li><a href="https://www.facebook.com/halfpricepackaging" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="https://twitter.com/halfpricepacka1" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    <li><a href="https://www.instagram.com/halfpricepackaging/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                    <li><a href="https://www.linkedin.com/company/halfpricepackaging" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                    <li><a href="https://www.youtube.com/channel/UCtGFbR-weWi7z18bB_YmGfA" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
                  </ul>
                </div>
                <div class="hd-logo-st">
                  <ul>
                    <li><a href="https://www.google.com/search?q=half+price+packaging&sxsrf=ALiCzsZM-fdsMbNFCTeTPuOSvy653ziIJw%3A1653824594538&source=hp&ei=UlyTYpbBHpSklwTCmIb4CA&iflsig=AJiK0e8AAAAAYpNqYno26egrlUnJ3LiwMkQFzHGhw2Sz&gs_ssp=eJzj4tVP1zc0zC0vTikwy0o3YLRSNaiwMLBISza3MLFMMzMwTE62tDKoMDcyNDQwMjVNTjU3MDU2SvESyUjMSVMoKMpMTlUoSEzOTkzPzEsHADnpFoE&oq=halfprice&gs_lcp=&sclient=gws-wiz" data-toggle="tooltip4" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Excellent - 4.6" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/head-logo-3.png"></a></li>
                    <li><a href="https://www.bark.com/en/us/company/half-price-packaging/ZwMpK/" data-toggle="tooltip1" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Reviews (55)" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/head-logo-2.png"></a></li>
                    <li><a href="https://www.reviews.io/company-reviews/store/halfpricepackaging-com" data-toggle="tooltip1" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Excellent - 4.7" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/56x22-review-logo.png"></a></li>
                    <li><a href="https://www.trustpilot.com/review/www.halfpricepackaging.com" data-toggle="tooltip" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Excellent - 4.8" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/head-logo-1.png"></a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-md-4 head-col-2 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.0s">
                <div class="head-btn-st">
                  <a href="https://wa.me/14155781759" target="_blank"><img src="{{asset('frontend')}}/images/hd-call-icon1.jpg"></a>
                  <a href="javascript:;" class="popup-btn-req btn-ani white"><img src="{{asset('frontend')}}/images/hd-call-icon3.png"></a>
                ...
                <div class="head-link-num-em">
                  ...
                  <a href="mailto:orders@halfpricepackaging.com"><i class="fa fa-envelope-square" aria-hidden="true"></i>orders@halfpricepackaging.com</a>
                </div>
              </div>
            </div>
            <div class="hdr-nav-list">
              <ul class="navbar-nav m-auto">
                <li class="dropdown_custom " id="dropdown_custom1">
                  <a class="dropdown-toggles" data-toggle="dropdowns" href="#">Box by Industry <span class="caret"></span></a>
                      ...
                      <div class="row flex_row">
                        <div class="col-sm-3 no-padding">
                          <div class="nav_main_categories">
                            <ul id="nav_main_categories">
                              ...
                              <li><a href="{{url('').'/'.$category->slug}}" onmouseover="getCategoryImage('{{$category->id}}')" class="@if($i == 1) active_navigation @endif" data-id="sub_menu_{{$category->id}}">{{ $category->cat_name}} </a> </li>
                              @php $i++ @endphp
                              @endforeach
                              @endif;
                            </ul>
                        ...
                        <div class="col-sm-3 no-padding">
                          <div class="nav_sub_products">
                            ...
                            <ul id="sub_menu_{{$category->id}}" class="@if($i != 1) sub_menu_none @endif">
                              ...
                              <li><a href="{{url('').'/'.$sub_category->slug}}" data-sub-id="layer_2_0_{{$sub_category->id}}" onmouseover="getSubCategoryImage('{{$sub_category->id}}')" class="@if($x == 1) active_sub_menu @endif">{{$sub_category->sub_cat_name}} </a> </li>
                              @php $x++ @endphp
                              @endforeach
                              @endif
                              ...
                              <div class="sub_menu_image">
                                <img src="{{asset($category->collection_image_path)}}">
                              </div>
                              @else
                              <div class="sub_menu_image">
                              </div>
                        ...
                        <div class="col-sm-6">
                          <div class="navigation_product_main">
                            ...
                            <div class="navigation_product_listing @if($i != 1) navigation_product_none @endif " id="layer_2_0_{{$sub_category->id}}">
              ...
              <ul>
                ...
                <div class="product_menu_image">
                  <img src="{{asset($sub_category->collection_image_path)}}">
                </div>
                @else
                <div class="product_menu_image">
                </div>
    ...
    <li class="nav-item dropdown_second_open"><a href="{{ url('box-by-material') }}">Box by Material</a>
      <ul class="deropdown_second">
        <li class="nav-item dropdown_second_inner"><a href="{{ url('cardboard-box-packaging') }}">Cardboard Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
        ...
        <li class="nav-item dropdown_second_inner"><a href="javascript:void(0)">Corrugated Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('kraft-box-packaging') }}">Kraft Bags and Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('rigid-box-packaging') }}">Rigid Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('holographic-stock-card-boxes') }}">Holographic Stock/Card Boxes <i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
    ...
    <li class="nav-item dropdown_second_open"><a href="{{ url('shapes-and-styles') }}">Shapes & Styles</a>
      <ul class="deropdown_second">
        <li class="nav-item dropdown_second_inner"><a href="{{ url('custom-bags') }}">Custom Bags<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('display-box-packaging') }}">Display Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
            ...
            <li class="nav-item"><a href="{{ url('auto-bottom-counter-display-toy-boxes') }}">Counter Display Toy Boxes</a></li>
            <li class="nav-item"><a href="{{ url('pharmaceutical-display-boxes') }}">Pharmaceutical Display Boxes</a></li>
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('mailer-box-packaging') }}">Mailer Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('shipping-and-delivery') }}">Shipping And Delivery<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('gable-packaging') }}">Gable Bags and Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('tuck-boxes') }}">Tuck Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('pillow-box-packaging') }}">Pillow Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('window-box-packaging') }}">Window Boxes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
            ...
            <li class="nav-item"><a href="{{ url('ziplock-paper-bags-with-windows') }}">Ziplock Paper Bags With Windows</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown_second_inner"><a href="{{ url('sleeve-and-tray-packaging') }}">Sleeve and Tray Packaging<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('subscription-box-packaging') }}">Subscription Box Packaging<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
        ...
        <li class="nav-item dropdown_second_inner"><a href="{{ url('custom-shapes') }}">Custom Shapes<i class="fa fa-caret-right" aria-hidden="true"></i></a>
          <ul class="deropdown_second_sub">
      ...
      <nav id="sidebar">
        ...
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            ...
            <a class="menu-arrow collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#submenu66" aria-expanded="false">
              <i class="fa fa-angle-down"></i>
            </a>
            <div class="collapse" id="submenu66" aria-expanded="false" role="submenu" style="">
              <ul class="flex-column nav">
                <li class="nav-item"><a href="{{ url('automotive-and-hardware-packaging') }}" class="nav-link">Automotive and Hardware Packaging</a></li>
                <li class="nav-item"><a href="{{ url('bakery-food-and-beverage-packaging') }}" class="nav-link">Bakery, Food & Beverage Packaging</a></li>
                <li class="nav-item"><a href="{{ url('business-essentials') }}" class="nav-link">Business Essentials</a></li>
                <li class="nav-item"><a href="{{ url('material-style-and-shape-packaging') }}" class="nav-link">Material, Style and Shape Packaging</a></li>
                <li class="nav-item"><a href="{{ url('cbd-and-tobacco-packaging') }}" class="nav-link">CBD and Tobacco Packaging</a></li>
                <li class="nav-item"><a href="{{ url('healthcare-and-pharma-packaging') }}" class="nav-link">Healthcare and Pharma Packaging</a></li>
                <li class="nav-item"><a href="{{ url('fashion-retail-and-electronics-packaging') }}" class="nav-link">Fashion, Retail & Electronics Packaging</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a href="{{ url('shapes-and-styles') }}">Shapes and Style</a>
            <a class="menu-arrow collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#submenu6" aria-expanded="false">
              <i class="fa fa-angle-down"></i>
            </a>
          ...
          <li><a href="{{ url('shapes-and-styles') }}">Shapes & Styles</a></li>
        ...
        <div class="hd-logo-st">
          <ul>
            ...
            <li><a href="https://www.bark.com/en/us/company/half-price-packaging/ZwMpK/" data-toggle="tooltip1" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Reviews (55)" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/head-logo-2.png"></a></li>
            <li><a href="https://www.google.com/search?q=half+price+packaging&sxsrf=ALiCzsZM-fdsMbNFCTeTPuOSvy653ziIJw%3A1653824594538&source=hp&ei=UlyTYpbBHpSklwTCmIb4CA&iflsig=AJiK0e8AAAAAYpNqYno26egrlUnJ3LiwMkQFzHGhw2Sz&gs_ssp=eJzj4tVP1zc0zC0vTikwy0o3YLRSNaiwMLBISza3MLFMMzMwTE62tDKoMDcyNDQwMjVNTjU3MDU2SvESyUjMSVMoKMpMTlUoSEzOTkzPzEsHADnpFoE&oq=halfprice&gs_lcp=&sclient=gws-wiz" data-toggle="tooltip4" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Excellent - 4.6" target="_blank"><img src="{{asset('frontend')}}/images/head-logo/head-logo-3.png"></a></li>
            <li><a href="https://www.reviews.io/company-reviews/store/halfpricepackaging-com" data-toggle="tooltip1" data-placement="bottom" title="&bigstar;&bigstar;&bigstar;&bigstar;&bigstar;Excellent - 4.7" target="_blank"><img src="https://www.halfpricepackaging.com/frontend/images/head-logo/56x22-review-logo.png"></a></li>
          </ul>
        </div>
      </nav>
    </div>

jQuery(document).ready(function($){
    ...
    /* footer */
    $(".footerNav span").click(function(){
        $(this).parent(".navStyle").toggleClass("open");
        $('html, body').animate({ scrollTop: jQuery(this).offset().top - 150 }, 500 );
    });

    /* responsive menu */
    $('#dismiss, .dismis, #overlay').on('click', function () {

...
$(function () {
    ...
    var activePage = url.substring(url.lastIndexOf('/') + 1); //sets the variable "activePage" as the substring after the last "/" in the "url" variable
        $('.hdr-nav-list ul li a').each(function () { //looks in each link item within the primary-nav list
...
$(' .menu_slider_nav').owlCarousel({
    ...
    responsive:{
        0:{
            ...
            nav:true,
            loop:false,
            navText: ['<span class="slide_prev"></span>','<span class="slide_next"></span>'],
        },
        600:{
            items:3,
            nav:true,
